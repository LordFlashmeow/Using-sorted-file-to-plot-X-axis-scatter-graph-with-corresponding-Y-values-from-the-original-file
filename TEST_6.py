...
us_csv_file = []
with open('firstFile.csv', 'r') as f:
...
plt.title("\n".join(wrap("Performance for stats-EHEALTH-betsy-201901.csv & stats-HPL-8C-8G-betsy-201901.csv & stats-BLASTX-betsy-201901.csv")),size = 9.5)
